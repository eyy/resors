...
Resors.middleware = function(resources) {
    ...
    app.get('/', function(req, res) {
        ...
        Object.keys(resources).forEach(function(path){
            ...
            o.methods = resource.modelName ? (resource.resors&&resource.resors.allow || Resors.defaults.allow) : resource.options.allow;
            o.filtering = resource.modelName ? (resource.resors&&resource.resors.filtering || Resors.helpers.paths(resource)) : resource.options.filtering;
            o.fields = resource.modelName ? (resource.resors&&resource.resors.fields || Resors.helpers.paths(resource)) : resource.options.fields;
